...
<div class="row">
  <div class="col-md-10">
     &nbsp; &nbsp; &nbsp; <h1 class="text-center"> <b>UBICACIÓN DE TODOS LOS CANDIDATOS 2023 </b> </h1>
  </div>
    <div class="col-md-2">
...
<br>
        ...
        <div class="col-md-4">
          ...
          <br>
          <br>
        <h3><i> <img src="<?php echo base_url('assets/images/icon1.png') ?>" alt=""> PRESIDENTES </i></h3>

        <h3><i> <img src="<?php echo base_url('assets/images/icon2.png') ?>" alt=""> ASAMBLEISTAS NACIONALES </i></h3>

        <h3><i> <img src="<?php echo base_url('assets/images/icon3.png') ?>" alt=""> ASAMBLEISTAS PROVINCIALES </i></h3>
        </div>
				<div class="col-md-8">
                ...
                <?php if($candidato1): ?>
                    ...
                    icon: "<?php echo base_url('assets/images/iconpresi.png'); ?>",
